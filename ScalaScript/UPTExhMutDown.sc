...
val CARTCfg = CfgMbss.fromFile("Models/UPTExh.cfg",
    BndMbss.fromFile("Models/UPTExh.bnd"))
...
lazy val ResPar8 = varMutPort.take(8).par.map(varPort => {
    print(varPort._1)
    val upModel = new UPMaBoSS("Models/UPTExh.upp", mutCARTCfg.update(Map(varPort._1 -> "1", "thread_count" -> "1")),
...
val pw = new PrintWriter(new File("Results/Mut8TumSizeTExh.csv"))
pw.write(ResList8)
pw.close()
// Mut 9 to 16
...
val pw = new PrintWriter(new File("Results/Mut16TumSizeTExh.csv"))
pw.write(ResList16)
pw.close()
//
// Mut 17 to 24
...
val pw = new PrintWriter(new File("Results/Mut24TumSizeTExh.csv"))
pw.write(ResList24)
pw.close()
// Mut 25 to 32
...
val pw = new PrintWriter(new File("Results/Mut32TumSizeTExh.csv"))
pw.write(ResList32)
pw.close()
// Mut 33 to 40
...
val pw = new PrintWriter(new File("Results/Mut40TumSizeTExh.csv"))
pw.write(ResList40)
pw.close()
// Mut 41 to 48
...
val pw = new PrintWriter(new File("Results/Mut48TumSizeTExh.csv"))
pw.write(ResList48)
pw.close()
// Mut 49 to 56
...
val pw = new PrintWriter(new File("Results/Mut56TumSizeTExh.csv"))
pw.write(ResList56)
pw.close()
// Mut 57 to 64
...
// add wild type
val upModel = new UPMaBoSS("Models/UPTExh.upp", mutCARTCfg.update(Map("thread_count" -> "1")),
    "localhost", listServerPorts.head, hexUP = true, verbose = false)
val upRes = upModel.runLight(20)

val pw = new PrintWriter(new File("Results/Mut64TumSizeTExh.csv"))
pw.write(ResList64+ "\n" + "wt" + "\t" +
